...
@SpringBootTest
@ActiveProfiles("test")
class PersonSortServiceImplIntegrationTest {
    ...
    void whenSortByIdAsc_thenOrderedAsc() {
        ...
        assertThat(sorted).extracting(PersonDto::id).containsExactly(1L, 2L, 3L);
    }
    ...
    void whenSortByIdDesc_thenOrderedDesc() {
        ...
        assertThat(sorted).extracting(PersonDto::id).containsExactly(3L, 2L, 1L);
    }
    ...
    void whenSortByNameAsc_thenOrderedCaseInsensitive() {
        ...
        assertThat(sorted).extracting(PersonDto::name).containsExactly("C-3PO", "Luke Skywalker", "R2-D2");
    }
    ...
    void whenSortByNameDesc_thenOrderedDescCaseInsensitive() {
        ...
        assertThat(sorted).extracting(PersonDto::name).containsExactly("R2-D2", "Luke Skywalker", "C-3PO");
    }
    ...
    @Test
    @DisplayName("When sort by created desc Then nulls first due to reversed comparator")
    void whenSortByCreatedDesc_thenNullsFirst() {
        ...
        assertThat(sorted.subList(1, 3)).extracting(PersonDto::id).containsExactly(2L, 1L);
    }
